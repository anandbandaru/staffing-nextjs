...
import { Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, TextField, InputAdornment, Button, Alert } from '@mui/material'; // Added InputAdornment import
            ...
            {apiLoading ? (
                ...
                <Box sx={{ width: '100%', typography: 'body1' }}>
                    {ID !== "" ?
                        ...
                        :
                        <>
                            <Alert severity="error" className="my-4">The related timesheet is not present.</Alert>
                        </>
                    }
