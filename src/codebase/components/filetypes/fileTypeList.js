...
const FileTypeList = () => {
    ...
    const CustomDetailsComponent = (props) => {
        return (
            <>
                <FileTypeDetails fileTypeID={props.data.Id} operation="View" doLoading={false} />
            </>
        );
    };
    const CustomEditComponent = (props) => {
        return (
            <>
                <FileTypeEdit fileTypeID={props.data.Id} operation="Edit" manualLoadData={manualLoadData} setApiLoading={setApiLoading} />
            </>
        );
    };
