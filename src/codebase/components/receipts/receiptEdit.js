...
function ReceiptEdit({ ID, operation, manualLoadData, setApiLoading, showSnackbar }) {
    ...
    const deleteItem = () => {
        setApiLoading(true);
        let apiUrl = APIPath + "/deletereceipt"
        axios.post(apiUrl,
            {
                Id: ID
            },
    ...
    return (
        <>
            ...
            >
                ...
                <DialogContent dividers>
                    <GenericFileForm moduleId={ID} componentName="RECEIPTS" />
                </DialogContent>
            </BootstrapDialog>
        </>
