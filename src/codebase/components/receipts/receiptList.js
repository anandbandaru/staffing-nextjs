...
import ReceiptsListToolbar from './receiptsListToolbar'
...
const ReceiptList = () => {
    ...
    const getList = () => {
        setData({ data: [] });
        let apiUrl = APIPath + "/getreceipts"
        fetch(apiUrl, {
            headers: {
                ...
                (result) => {
                    ...
                    if (result.error) {
                        ...
                        if (result.STATUS === "FAIL") {
                            ...
                            showSnackbar('success', "Receipts Data fetched");
                    }
                    setApiLoading(false);
                },
                (error) => {
    ...
    const CustomDetailsComponent = (props) => {
        return (
            <>
                <GenericDetails ID={props.data.Id} operation="View" doLoading={false} moduleName="RECEIPTS" />
            </>
        );
    };
    const CustomEditComponent = (props) => {
        return (
            <>
                <ReceiptEdit ID={props.data.Id} operation="Edit" manualLoadData={manualLoadData} setApiLoading={setApiLoading} showSnackbar={showSnackbar} />
            </>
        );
    };
