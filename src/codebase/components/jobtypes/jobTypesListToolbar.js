...
const JobTypesListToolbar = ({ operation, itemCount, apiLoading, apiLoadingError, dataAPIError, manualLoadData }) => {
...
export default JobTypesListToolbar;