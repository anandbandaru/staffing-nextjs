...
import ExpenseTypesListToolbar from './expenseTypesListToolbar'
...
const ExpenseTypeList = () => {
    ...
    const CustomDetailsComponent = (props) => {
        return (
            <>
                <GenericDetails ID={props.data.Id} operation="View" doLoading={false} moduleName="EXPENSETYPES" />
            </>
        );
    };
    const CustomEditComponent = (props) => {
        return (
            <>
                <ExpenseTypeEdit ID={props.data.Id} operation="Edit" manualLoadData={manualLoadData} setApiLoading={setApiLoading} showSnackbar={showSnackbar} />
            </>
        );
    };
