...
const EmployeesReport = () => {
    ...
    const fetchData = async () => {
        ...
        axios.get(APIPath + "/getemployees", {
            ...
            const disabledCount = employeesData.filter(employee => employee.Disabled === true).length;
            const activeCount = employeesData.filter(employee => employee.Disabled === false || employee.Disabled === null).length;
            setData([
