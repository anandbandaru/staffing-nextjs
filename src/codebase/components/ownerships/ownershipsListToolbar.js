...
const OwnershipsListToolbar = ({ operation, itemCount, apiLoading, apiLoadingError, dataAPIError, manualLoadData }) => {
...
export default OwnershipsListToolbar;