...
function ImpPartnerDetails({ ID, operation, doLoading }) {
            ...
            .then(
                (result) => {
                    ...
                    if (result.error) {
                        ...
                        setDataAPIError(result.total == 0 ? "No Implementation Partner information present." : "ok");
                    }
                    setApiLoading(false);
                },
                (error) => {
...
export default ImpPartnerDetails;