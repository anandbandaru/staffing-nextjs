...
function ADP_FORM_Upload({ userEmployeeId, operation, code }) {
                ...
                {(props) => {
                    ...
                    return (
                        <form onSubmit={handleSubmit}>
                            <Alert severity="error">Ensure to double-check the routing and account numbers.</Alert>
...
export default ADP_FORM_Upload;