...
function WORK_PERMIT_Upload({ userEmployeeId, operation, code }) {
        ...
        <>
            ...
            <Formik
                ...
                validationSchema={Yup.object().shape({
                    WORK_PERMIT_Type: Yup.string()
                        .required(code + ' Type Required'),
                    WORK_PERMIT_ExpiryDate: Yup.string()
                    ...
                    return (
                        <form onSubmit={handleSubmit}>
                            <TextField
                                ...
                                value={values.WORK_PERMIT_Type}
                                onChange={handleChange}
                                onBlur={handleBlur}
                                helperText={(errors.WORK_PERMIT_Type && touched.WORK_PERMIT_Type) && errors.WORK_PERMIT_Type}
                            >
                                {configData.workPermitTypes.map((item, index) => (
                            ...
                            <Stack direction="row" spacing={2} className="flex items-center pl-2 mt-4">
                                ...
                                <TextField
                                    ...
                                    fullWidth
                                    className='flex-1'
                                    id="WORK_PERMIT_ExpiryDate"
                                    name="WORK_PERMIT_ExpiryDate"
                                    type="date"
                                    value={values.WORK_PERMIT_ExpiryDate}
                                    onChange={handleChange}
                                    onBlur={handleBlur}
                                    helperText={(errors.WORK_PERMIT_ExpiryDate && touched.WORK_PERMIT_ExpiryDate) && errors.WORK_PERMIT_ExpiryDate}
                                />
                            </Stack>
...
export default WORK_PERMIT_Upload;