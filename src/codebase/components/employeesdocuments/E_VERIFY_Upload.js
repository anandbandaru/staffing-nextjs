...
function E_VERIFY_Upload({ userEmployeeId, operation, code, manualLoadData }) {
                ...
                {(props) => {
                    ...
                    return (
                        <form onSubmit={handleSubmit}>
                            ...
                            <Stack direction="row" spacing={2} className="flex items-center pl-2 my-4">
                                ...
                                <Link
                                    href="https://tinywow.com/tools/pdf"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    underline="none"
                                >
                            ...
                            <Alert severity="error">Ensure you are E-Verifying the correct Employee.</Alert>
...
export default E_VERIFY_Upload;