...
function PASSPORT_Upload({ userEmployeeId, operation, code }) {
        ...
        <>
            ...
            <Formik
                ...
                validationSchema={Yup.object().shape({
                    PASSPORT_IDNumber: Yup.string()
                        .required(code + ' Number Required'),
                    PASSPORT_IssueDate: Yup.string()
                        .required(code + ' Issue Date Required'),
                    PASSPORT_ExpiryDate: Yup.string()
                    ...
                    return (
                        <form onSubmit={handleSubmit}>
                            <TextField
                                ...
                                margin="normal"
                                fullWidth
                                id="PASSPORT_IDNumber"
                                name="PASSPORT_IDNumber"
                                label="PASSPORT Number"
                                value={values.PASSPORT_IDNumber}
                                onChange={handleChange}
                                onBlur={handleBlur}
                                helperText={(errors.PASSPORT_IDNumber && touched.PASSPORT_IDNumber) && errors.PASSPORT_IDNumber}
                            />
                            <Stack direction="row" spacing={2} className="flex items-center pl-2 mt-4">
                                ...
                                <TextField
                                    ...
                                    fullWidth
                                    className='flex-1'
                                    id="PASSPORT_IssueDate"
                                    name="PASSPORT_IssueDate"
                                    type="date"
                                    value={values.PASSPORT_IssueDate}
                                    onChange={handleChange}
                                    onBlur={handleBlur}
                                    helperText={(errors.PASSPORT_IssueDate && touched.PASSPORT_IssueDate) && errors.PASSPORT_IssueDate}
                                />
                            </Stack>
                            <Stack direction="row" spacing={2} className="flex items-center pl-2 mt-4">
                                ...
                                <TextField
                                    ...
                                    type="date"
                                    value={values.PASSPORT_ExpiryDate}
                                    onChange={handleChange}
                                    onBlur={handleBlur}
                                    helperText={(errors.PASSPORT_ExpiryDate && touched.PASSPORT_ExpiryDate) && errors.PASSPORT_ExpiryDate}
                                />
                            </Stack>
...
export default PASSPORT_Upload;