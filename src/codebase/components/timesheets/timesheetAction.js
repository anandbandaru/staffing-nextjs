...
function TimesheetAction({ ID, timesheetNumber, mode, operation, manualLoadData,
    setApiLoading, showSnackbar, employeeID, startDate, endDate, jobName, personalEmail, applicationEmail, viewType }) {
